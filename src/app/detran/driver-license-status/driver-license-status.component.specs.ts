...
describe( 'Detran/driver-license-status', () => {
    ...
    describe( 'Controller', () => {
        ...
        beforeEach(() => {
            ...
            controller = new DriverLicenseStatusController( environment.$scope, ticketColorService, detranApiService, driverLicenseStorage, transitionService, $mdDialogMock );
        });
