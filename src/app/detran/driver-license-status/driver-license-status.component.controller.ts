...
export class DriverLicenseStatusController {
    ...
    public static $inject: string[] = [ '$scope', 'ticketColorService', 'detranApiService', 'detranStorage', 'transitionService', '$mdDialog' ];
    ...
    constructor( private $scope: IScope,
        ...
        this.$scope.$on( '$ionicView.beforeEnter', () => this.redirectIfNeeded() );
    }
     ...
     * @memberOf DriverLicenseStatusController
     */
    public redirectIfNeeded() {
        if ( !this.driverLicenseStorage.hasDriverLicense ) {
            this.transitionService.changeMenuState( 'app.driverLicense' );
        }
    }
